 ...
 *
 * ```js
 * var kontrolyApp = angular.module('kontrolyApp', []);
 * kontrolyApp.run(function($templateCache) {
 ...
 *
 * - your app is hosted at url `http://kontrolyApp.example.com/`
 * - but some of your templates are hosted on other domains you control such as
 *   `http://srv01.assets.example.com/`,  `http://srv02.assets.example.com/`, etc.
 * - and you have an open redirect at `http://kontrolyApp.example.com/clickThru?...`.
 *
 * Here is what a secure configuration for this scenario might look like:
 *
 * <pre class="prettyprint">
 *    angular.module('kontrolyApp', []).config(function($sceDelegateProvider) {
 ...
 *        'http://kontrolyApp.example.com/clickThru**']);
 *      });
 * </pre>
 */
